...
\begin{lemma}{Isometric Path}{}
    Let G be any graph, $u,v \in V(G) , u \neq v, P = {u, v_1, \dots, v_t = v}$ a shotrest path between u and v. We assume that at least two cops are in play. Then a cop C on P can, after a finite number of moves, prevent the robber R from entering P.  That is, R will be immediately caught if he moves to P.
\end{lemma}
